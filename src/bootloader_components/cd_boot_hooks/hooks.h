...
// keep same as main.h
#define BL_MCO_PIN          3
#define BL_CD_MISO_PIN      2
#define BL_CD_MOSI_PIN      7
#define BL_CD_SCK_PIN       6
#define BL_CD_CS_PIN        10
#define BL_LED_PIN          8          // green led (LED_G_PIN)
